...
function Invoke-RotationAuthorityRequest(
  [ValidateSet('CREATE_CANONICAL_PLAN','INITIALIZE_OPERATION','GET_OPERATION_STATE','GET_RECOVERY_CLASSIFICATION','CONSUME_ACTIVATION_ATTEMPT','RECORD_ACTIVATION_FAILURE','CONSUME_ROLLBACK_ATTEMPT','CONFIRM_CANDIDATE','CONFIRM_ROLLBACK','RECORD_MANUAL_INTERVENTION')][string]$Operation,
