...
try {
  ...
  $enablementRejectCases = @(
    ...
    @{ Name='GITHUB_UPPERCASE_TRUE_REJECTED'; Runtime=@('GITHUB_ACTIONS_ENABLED=TRUE','JENKINS_INTEGRATION_ENABLED=false') },
    ...
    @{ Name='JENKINS_UPPERCASE_FALSE_REJECTED'; Runtime=@('GITHUB_ACTIONS_ENABLED=true','JENKINS_INTEGRATION_ENABLED=FALSE') },
